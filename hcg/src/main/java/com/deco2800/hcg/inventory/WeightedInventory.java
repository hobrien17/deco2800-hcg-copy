...
public class WeightedInventory implements Inventory {
	 ...
	 *  @return
	 *  	The max amount of weight able to be stored in this inventory. */
	 ...
	 *  @return
	 *  	The amount of free space left in this inventory. */
	 ...
	 *  @return
	 *  	The amount of weight currently stored in this inventory. */
