...
public interface Inventory extends Iterable<Item> {
     ...
     * inventory.
     *
     * @param index The position of the item to be retrieved.
     * @return The item stored at position <code>index</code>.
     */
    public Item getItem(int index);

    /**
     * Remove the item stored at position <code>index</code> inside this
     * inventory.
     *
    ...
    /**
     * Tests whether or not this inventory can currently accept
     * <code>item</code>.
     *
     * @param item The item to be tested.
     * @return Whether or not the item is able to be inserted into the
     * inventory.
     */
    public boolean canInsert(Item item);

    /**
     * Inserts <code>item</code> into position <code>index</code> in the
     * inventory if possible.
     *
     * @param item The item to insert into the inventory.
     * @param index The position to insert the item into.
     * @return Whether or not the item was able to be inserted into the
     * inventory.
     */
