...
public abstract class Character extends AbstractEntity {
    ...
    protected void setAttributes(int strength, int vitality, int agility, int charisma, int intellect) {
    ...
    protected void setMeleeSkill(int meleeSkill) { this.meleeSkill = meleeSkill; }
