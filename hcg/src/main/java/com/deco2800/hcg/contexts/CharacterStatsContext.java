...
public class CharacterStatsContext extends CharacterContext {
    ...
    private void setupSkillsWindow() {
        int meleeSkill = playerManager.getPlayer().getAttribute("meleeSkill");
        int gunsSkill = playerManager.getPlayer().getAttribute("gunsSkill");
        int energyWeaponsSkill = playerManager.getPlayer().getAttribute("energyWeaponsSkill");

        Label meleeSkillLabel = new Label("Melee Skill: " + meleeSkill, skin);
        Label gunsSkillLabel = new Label("Guns Skill: " + gunsSkill, skin);
        Label energyWeaponsSkillLabel = new Label("Energy Weapons Skill: " + energyWeaponsSkill, skin);
