...
public class Box3D {
     ...
     * @param z The corner point z-coordinate.
     * @param xLength The xLength (in x).
     * @param yLength The yLength (in y).
     * @param zLength The zLength (in z).
     */
    public Box3D(float x, float y, float z, float xLength, float yLength,
            float zLength) {
        this.x = x;
        this.y = y;
        this.z = z;
