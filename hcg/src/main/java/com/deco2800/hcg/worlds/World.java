...
public class World {
	...
	public World(String file) {
		 ...
		 * 
		 * TiledMapTileLayer tiled = (TiledMapTileLayer)
		 * map.getLayers().get("ground");
		 * 
		 * for (int i = 0; i < 10; i++){ tiled.getCell(i, i).setTile(new
		 * StaticTiledMapTile( new
		 * TextureRegion(biome.getTexture(TileTypes.PATH)))); }
		 */
